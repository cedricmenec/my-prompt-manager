...
Defines visible Google Drive snapshot creation, automatic snapshot eligibility, pre-operation snapshots, and restore behavior for non-sensitive prompt data.
