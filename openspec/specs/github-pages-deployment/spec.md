...
Automates the build and deployment of the application to GitHub Pages whenever changes are pushed to the `main` branch. This ensures a live version of the app is always accessible at `https://cedricmenec.github.io/my-prompt-manager/`.
