# magic-input Specification

## Purpose
Reusable MagicInput component combining an input/textarea with an integrated magic wand icon for triggering AI-assisted field generation. Used in PromptView edit mode for Title and Description fields.
