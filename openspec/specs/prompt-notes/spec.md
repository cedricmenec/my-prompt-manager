...
Defines the free-text `notes` field on the `Prompt` domain type, covering its storage in YAML frontmatter and round-trip behaviour through the Markdown serializer/parser.
