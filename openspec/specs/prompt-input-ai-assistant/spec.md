# Prompt Input AI Assistant

## Purpose

Defines the prompt input assistant feature: AI-powered generation of prompt titles and descriptions from prompt content using a user-configured OpenRouter model.
