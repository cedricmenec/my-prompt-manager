...
Defines the foundational setup for the BYO Prompt Manager static web app: toolchain, TypeScript configuration, styling integration, folder conventions, and test infrastructure.
