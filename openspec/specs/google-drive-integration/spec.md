...
Defines the user-owned Google Drive configuration, session-only OAuth behavior, visible folder access checks, error handling, and documentation boundaries for the static local-first app.
